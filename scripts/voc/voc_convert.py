...
flags.DEFINE_string(
    "train_list_txt",
    "../../data/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/ImageSets/Main/train.txt",
    "path to a set of train",
)
flags.DEFINE_string(
    "val_list_txt",
    "../../data/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/ImageSets/Main/val.txt",
    "path to a set of val",
)
flags.DEFINE_string(
    "classes", "../../data/classes/voc2012.names", "path to a list of class names"
)
flags.DEFINE_string(
    "train_output", "../../data/dataset/voc2012_train.txt", "path to a file for train"
)
flags.DEFINE_string(
    "val_output", "../../data/dataset/voc2012_val.txt", "path to a file for val"
)

flags.DEFINE_boolean(
    "no_val", False, "if uses this flag, it does not convert a list of val"
)
        ...
        while True:
            ...
            for b, n in zip(bboxes, names):
                ...
                box_annotations.append(
                    ",".join(
                        [str(xmin), str(ymin), str(xmax), str(ymax), str(class_idx)]
                    )
                )
