...
flags.DEFINE_string(
    "weights", "./checkpoints/yolov4-416/variables/variables", "path to weights file"
)
...
flags.DEFINE_string(
    "output_format", "mp4v", "codec used in VideoWriter when saving video to file"
)
flags.DEFINE_boolean(
    "dis_cv2_window", False, "disable cv2 window during the process"
...
def main(_argv):
    ...
    frame_id = 0
    ### Code to remove output images generated in previous run
    mypath = "./output/"
